...
contract CryptosICO is CryptosToken {
    ...
    // 1CRPT = 0.001 ETHER, 1 ETHER = 1000 CRPT
    ...
    // min cap
    // uint public softCap = 100000000000000000;

    uint public raisedAmount;

    uint public saleStart = now;
    uint public saleEnd = now + 604800; // one week
    uint public coinTradeStart = saleEnd + 604800; // transferable in a week after selesEnd
    ...
    function invest() payable public returns(bool) {
        ...
        deposit.transfer(msg.value); // transfer ethers to the deposit address
